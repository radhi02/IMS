...
<div class="content">
    <div class="page-header">
        <div class="page-title">
            <h4>Demand Note List</h4>
            <h6>Manage your demand note</h6>
        </div>
        <!-- <div class="page-btn">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table datanew">
                    ...
                    <tbody>
                        @foreach($DemandNoteList as $k=>$values)
                        <tr id="id_rmv{{$values->id}}">
                            ...
                            <td>
                                ...
                                <a class="me-3" href="{{route('issuematerial.create',['id'=>$values->id])}}" title="Issue">
                                    <img src="{{URL::asset('admin_asset/img/icons/quotation1.svg')}}" alt="img" style=" height: 24px; width: 24px; ">
                                </a>
                                @endif
                                <a class="me-3" href="{{route('demandnote.showDemand',['id'=>$values->id])}}" title="Show">
                                    <img src="{{URL::asset('admin_asset/img/icons/eye.svg')}}" alt="img" style=" height: 24px; width: 24px; ">
                                </a>
                            </td>
                        </tr>
                        @endforeach
