...
<body>
    <div class="container mt-5">
        <h4 class="text-center mb-3">Issue Note # <?php echo $IssueNoteList['code'] ?></h4>
        <div class="row" style="margin-bottom: 25px;">
            ...
            <div class="col-md-4">
                <ul class="list-unstyled mb-0">
                    <li>Issue Date :</li>
                    <li><?php echo ShowNewDateFormat($IssueNoteList['date']) ?> </li>
                </ul>
            </div>
        </div>
        <table class="table table-bordered table-sm mb-5">
            ...
            <tbody>
                <?php 
            // print_r($IssueNoteList->code); 
            if(!empty($IssueNoteList['materialnote'])) {
                $tmpNote = json_decode($IssueNoteList['materialnote'],true); $i = 1;
                if(count($tmpNote) > 0) { 
