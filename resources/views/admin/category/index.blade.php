    ...
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{route('category.create')}}" class="btn btn-added"><img
                    src="{{URL::asset('admin_asset/img/icons/plus.svg')}}" alt="img" class="me-1">Add New Category</a>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
                ...
                <table class="table datanew">
                    ...
                    <tbody>
                        ...
                        <tr id="id_rmv{{$values->id}}">
                            ...
                            <td>
                                <a class="me-3" href="{{route('category.show',$values->id)}}">
                                    <img src="{{URL::asset('admin_asset/img/icons/eye.svg')}}" alt="img">
                                </a>
                                <a class="me-3" href="{{route('category.edit',$values->id)}}">
...
$(".Delete").click(function() {
    removethis($(this).data('id'), "{{url('category_destroy')}}", "{{ csrf_token() }}");
});

$('.statuschange').change(function() {
    changeAllStatus($(this).val(), "{{route('category.status')}}", "{{ csrf_token() }}");
});
</script>
@endsection