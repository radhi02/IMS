    ...
    <div class="page-header">
        ...
        <div class="page-btn">
            <a href="{{route('subcategory.create')}}" class="btn btn-added"><img
                    src="{{URL::asset('admin_asset/img/icons/plus.svg')}}" alt="img" class="me-1">Add New Sub Category</a>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
                ...
                <table class="table datanew">
                    ...
                    <tbody>
                        ...
                        <tr id="id_rmv{{$values->id}}">
                            ...
                            <td>
                                <a class="me-3" href="{{route('subcategory.show',$values->id)}}">
                                    <img src="{{URL::asset('admin_asset/img/icons/eye.svg')}}" alt="img">
                                </a>
                                <a class="me-3" href="{{route('subcategory.edit',$values->id)}}">
...
$(".Delete").click(function() {
    removethis($(this).data('id'), "{{url('subcategory_destroy')}}", "{{ csrf_token() }}");
});

$('.statuschange').change(function() {
    changeAllStatus($(this).val(), "{{route('subcategory.status')}}", "{{ csrf_token() }}");
});
</script>
@endsection