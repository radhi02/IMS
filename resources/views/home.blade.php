...
<div class="row">
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="dash-widget">
                ...
                <div class="dash-widgetcontent">
                    <h5>₹ <span class="counters" data-count="{{$cashcounter['total_purchase_amt']}}">₹ {{$cashcounter['total_purchase_amt']}}</span></h5>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="dash-widget dash1">
                ...
                <div class="dash-widgetcontent">
                    <h5>₹ <span class="counters" data-count="{{$cashcounter['total_sale_amt']}}">₹ {{$cashcounter['total_sale_amt']}}</span></h5>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="dash-widget dash3">
                ...
                <div class="dash-widgetcontent">
                    <h5>₹ <span class="counters" data-count="{{$cashcounter['sale_due_amt']}}">₹ {{$cashcounter['sale_due_amt']}}</span></h5>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
            <div class="dash-widget dash2">
                ...
                <div class="dash-widgetcontent">
                    <h5>₹ <span class="counters" data-count="{{$cashcounter['sale_received_amt']}}">₹ {{$cashcounter['sale_received_amt']}}</span></h5>
