...
$(document).ready(function(){
	...
	var checkboxItem = ".select-all-sub";
	...
	$(checkboxItem).click(function(){
		if($(checkboxItem).length == $(".select-all-sub:checked").length) {
		...
		'<li class="sidebar-icons">' +
			'<a class="toggle tipinfo open-layout open-siderbar" href="javascript:void(0);" data-toggle="tooltip" data-placement="left" data-bs-original-title="Tooltip on left">' +
				'<div class="tooltip-five ">' +
					'<img src="{{URL::asset(admin_asset/img/icons/siderbar-icon2.svg)}}" class="feather-five" alt="">' +
					...
					'<div class="col-xl-6 col-sm-6 col-12">' +
						'<div class="sidebar-logo">' +
							'<a href="{{route(home)}}" class="logo">' +
								'<img src="{{URL::asset(admin_asset/img/imslogo.png)}}" alt="Logo" class="img-flex">' +
							'</a>' +
						'</div>' +
					'</div>' +
					'<div class="col-xl-6 col-sm-6 col-12">' +
						'<a class="btn-closed" href="javascript:void(0);"><img class="img-fliud" src="{{URL::asset(admin_asset/img/icons/sidebar-delete-icon.svg)}}" alt="demo"></a>' +
					'</div>' +
				'</div>' +
			'</div>' +
		'</div>' +
			...
			'<div class="row align-items-center">' +
				...
				'<div class="col-xl-12 col-sm-6 col-12">' +
					'<div class="sidebar-image align-center">' +
						'<img class="img-fliud" src="{{URL::asset(admin_asset/img/demo-one.png)}}" alt="demo">' +
					'</div>' +
					'<div class="row">' +
